resource "aws_autoscaling_group" "main_asg" {
  ...
  vpc_zone_identifier       = data.terraform_remote_state.priv_sub_ids.outputs.private_subnet_id
  instance_refresh {
    strategy = "Rolling"
    preferences {
...
resource "aws_autoscaling_attachment" "asg_attachment_bar" {
  ...
  lb_target_group_arn    = data.terraform_remote_state.target_group_arn.outputs.target_group_arn
}
